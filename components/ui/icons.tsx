...
export function SendIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={cn('', className)}
    >
      <path d="M9.912 8.088L21.177 2.825a.7.7 0 0 1 .997.997l-5.263 11.265M9.912 8.088l4.597 4.597M9.912 8.088L2.825 21.177a.7.7 0 0 0 .997.997l11.265-5.263" />
    </svg>
  )
}
...
// Missing icons that are imported in the codebase
...
export function BarChart3Icon({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LayoutDashboardIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// Export all icons as a named object for easier importing
export const Icons = {
  heart: HeartIcon,
  send: SendIcon,
