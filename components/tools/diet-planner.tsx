...
export function DietPlannerInterface() {
  ...
  const generateAIDietPlan = async () => {
    ...
    try {
      ...
      // Generate meal plans for each day of the week using Cerebrus AI
      ...
      <Card className="border-2 border-primary/20 bg-gradient-to-r from-primary/5 to-primary/10">
        <CardHeader>
          ...
          <CardDescription className="text-base">
            ...
            Powered by advanced AI from Cerebrus gpt-oss-120b and nutritional science.
          </CardDescription>
        </CardHeader>
      </Card>
            ...
            <div className="py-12 text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Cerebrus gpt-oss-120b is analyzing your profile and creating unique recipes...
                </p>
              </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              Cerebrus gpt-oss-120b analyzes your profile to create truly personalized meal plans
              with unique recipes
            </CardContent>
          </Card>
          <Card>
