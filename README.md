...
### 🤖 AI Chat Support
- Real-time streaming responses with Cerebrus gpt-oss-120b
...
- **ORM**: Drizzle 0.44
- **Auth**: NextAuth v5
- **AI**: Vercel AI SDK + Cerebrus gpt-oss-120b
...
# AI
CEREBRUS_API_KEY="your-cerebrus-key"
...
4. **Cerebrus API**: [Cerebras Platform](https://cloud.cerebras.ai/)
